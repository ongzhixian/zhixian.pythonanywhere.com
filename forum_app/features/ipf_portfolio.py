...
class IpfPortfolioFeature(BaseFeatureInterface):
    ...
    def feature_name(self):
        ...
        return "IPF Portfolio"

    @property
    def feature_description(self):
        """feature_description getter property. (required)"""
        return "Enable IPF Portfolio module"
    ...
    def register(self):
        if self.is_registered(self.feature_name):
            return
        self.register_feature(self.feature_name, self.feature_description, __name__, "Investment Portfolio")
        database_table_scripts_path = path.join(app_path, 'data', 'feature_database_scripts', 'ipf_portfolio', 'tables')
        self.db.run_scripts_in_path(database_table_scripts_path)
        database_table_scripts_path = path.join(app_path, 'data', 'feature_database_scripts', 'ipf_portfolio', 'data')
        self.db.run_scripts_in_path(database_table_scripts_path)
