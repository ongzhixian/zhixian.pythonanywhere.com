...
class DevelopmentFeature(BaseFeatureInterface):
    ...
    def feature_description(self):
        ...
        return "Enable development module"
    ...
    def register(self):
        if self.is_registered(self.feature_name):
            return
        database_table_scripts_path = path.join(app_path, 'data', 'feature_database_scripts', 'development', 'tables')
