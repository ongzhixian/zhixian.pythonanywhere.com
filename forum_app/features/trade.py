...
class TradeFeature(BaseFeatureInterface):
    ...
    def register(self):
        ...
        BaseMenuInterface().add_menu_item(self.feature_name, 'Trade', 'Trade module', '/trade/dashboard', 'Applications')
