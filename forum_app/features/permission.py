...
class PermissionFeature(BaseFeatureInterface):
    ...
    def feature_description(self):
        ...
        return "Enable permission module"
    ...
    def register(self):
        if self.is_registered(self.feature_name):
            return
        database_table_scripts_path = path.join(app_path, 'data', 'feature_database_scripts', 'permission', 'tables')
        self.db.run_scripts_in_path(database_table_scripts_path)
        database_table_scripts_path = path.join(app_path, 'data', 'feature_database_scripts', 'permission', 'views')
        self.db.run_scripts_in_path(database_table_scripts_path)
        self.register_feature(self.feature_name, self.feature_description, __name__, 'Role')
