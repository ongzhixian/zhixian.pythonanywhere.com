...
class DatabaseFeature(BaseFeatureInterface):
    ...
    def register(self):
        ...
        database_table_scripts_path = path.join(app_path, 'data', 'feature_database_scripts', 'database', 'data')
        self.db.run_scripts_in_path(database_table_scripts_path)
        BaseMenuInterface().add_menu_item(self.feature_name, 'Database', 'Database module', '/database', 'Administration')
